...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_Url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./model/Url */
    ...
    function AppComponent_div_19_button_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_19_button_5_Template_button_click_0_listener() {
    ...
    function AppComponent_div_19_button_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(http) {
        ...
        this.urlToShorten = '';
        this.urls = []; // -- Service methods - may create service component
      ...
      _createClass(AppComponent, [{
        ...
        key: "newShortUrl",
        value: function newShortUrl() {
          var _this = this;

          var request = {};
          request['url'] = this.urlToShorten;
          var url = new _model_Url__WEBPACK_IMPORTED_MODULE_2__["Url"](this.urlToShorten);
          this.postUrlRequest(request).subscribe(function (resp) {
        ...
        value: function copyUrl(url) {
          var _short = url.shortUrl;
          navigator.clipboard.writeText(_short);
          this.setCopied(url);
        }
      }, {
        key: "reset",
        ...
        key: "setCopied",
        value: function setCopied(copiedUrl) {
          this.urls.forEach(function (url) {
        ...
        key: "postUrlRequest",
        value: function postUrlRequest(url) {
          return this.http.post('https://rel.ink/api/links/', JSON.stringify(url), this.httpOptions);
        }
      }, {
        key: "getUrlInfoRequest",
        value: function getUrlInfoRequest(hash) {
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_13_listener($event) {
            return ctx.urlToShorten = $event;
          })("focus", function AppComponent_Template_input_focus_13_listener() {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _nav_nav_component__WEBPACK_IMPORTED_MODULE_6__["NavComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppModelUrlTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppNavNavComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 1,
      consts: [["src", "././assets/images/logo.svg", "alt", "Shortly", 1, "logo-img"], ["src", "././assets/images/hamburger.png", "alt", "expand menu", 1, "menu-icon", 3, "click"], ["class", "mobile-nav", 4, "ngIf"], [1, "mobile-nav"], [1, "nav-list"], [1, "nav-item"], [1, "login-options"], [1, "btn", "btn-pill"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/Emily/Documents/CodeProjects/url-shortening-landing-page-master/url-shortening-landing-page/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
